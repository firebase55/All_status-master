package my.video.saver.fragment;
...
import my.video.saver.activity.FullViewActivity;
import my.video.saver.activity.GalleryActivity;
import my.video.saver.adapter.FileListAdapter;
import my.video.saver.databinding.FragmentHistoryBinding;
import my.video.saver.interfaces.FileListClickInterface;
import org.jetbrains.annotations.NotNull;
import java.io.File;
import java.util.ArrayList;

import static androidx.databinding.DataBindingUtil.inflate;
import static my.video.saver.util.Utils.RootDirectoryWhatsappShow;
